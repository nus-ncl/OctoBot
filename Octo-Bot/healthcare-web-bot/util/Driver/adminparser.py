...
getNumberRecords obtains the number of accounts in the csv files
checkFileExist checks if that the adminLogin csv files are already created
genAdminFiles generate adminLogin csv files if they do not exist yet
getCredentials obtain username and password from adminLogin csv files 
getUrl obtains the target url
"""
