...
""" Helper function to automate the retrieval of therapist information

numberOfEnteries function obtains the number of patient records in the page
loginTherapist function logs in the therapist
checkResults function checks if there are entries on the page
getPersonalInformation function obtains personal information of the patient 
getDiagnosis obtains the diagnosis of the patient
getPermissions gets the permissions of the therapist
iteratePage iterates through the therapist on the page
"""
